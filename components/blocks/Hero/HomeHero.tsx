...
import HeroImage from '@/assets/img/bg/assurance-genevoise-geneve-assurance.webp';
    ...
    <div className="flex flex-col lg:gap-16 gap-12">
      ...
      <div className="flex flex-col relative items-start justify-between">
        <div className="w-full">
          <Image
            alt="Assurance Genevoise, votre courtier en assurance à Genève"
            title="Assurance Genevoise, votre courtier en assurance à Genève"
            src={HeroImage}
            width={1240}
            height={480}
