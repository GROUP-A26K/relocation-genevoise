...
interface IBookConsultation2Props {
  heading?: string;
  subHeading?: string;
  description?: string;
  buttonText1?: string;
...
export const BookConsultation2: React.FC<IBookConsultation2Props> = ({
      ...
      <div className="flex flex-col gap-12 rounded-xl bg-grey-50 py-12 lg:gap-16 lg:py-16">
        <div className="flex w-full items-center justify-center">
          <div className="flex w-full flex-col items-center gap-4 text-left lg:gap-8">
            <RevealItem className="flex max-w-180 flex-col items-center gap-3">
