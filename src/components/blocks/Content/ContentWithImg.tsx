    ...
    <div className="flex flex-col lg:gap-16 gap-14">
      <div className="flex flex-col lg:flex-row items-center justify-end lg:gap-16 gap-12">
        <Image
          ...
          width={576}
          height={360}
          className="lg:max-h-[360px] xl:min-w-[576px] max-h-[226px]  rounded-2xl object-cover order-2 lg:order-1"
        />
        <div className="flex flex-col items-start gap-6 lg:justify-center text-left order-1 lg:order-2">
