  ...
  return (
    <div className="flex flex-col gap-14 lg:gap-16">
      <div className="flex flex-col justify-between gap-6 lg:flex-row">
        <RevealItem className="flex w-full flex-col items-start justify-start gap-3 text-left">
        ...
        <RevealItem className="flex max-w-[600px] flex-col items-start justify-start gap-6 text-left">
