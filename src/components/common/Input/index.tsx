...
interface IInputDefaultProps extends React.AnchorHTMLAttributes<HTMLButtonElement> {
  href?: never;
  target?: never;
  onClick?: () => void;
  as: 'input';
...
interface IInputBaseProps extends React.ComponentProps<'input'> {
  className?: string;
  disabled?: boolean;
  error?: boolean;
}

type TInputProps = IInputBaseProps & (IInputDefaultProps | IInputSearchProps);
