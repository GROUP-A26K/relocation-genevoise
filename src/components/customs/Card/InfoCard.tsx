...
export const InfoCard: React.FC<Props> = ({
  ...
  return (
    <div className="flex p-6 items-center justify-center flex-col w-full lg:gap-4 gap-4 leading-none no-underline transition-colors outline-hidden select-none">
