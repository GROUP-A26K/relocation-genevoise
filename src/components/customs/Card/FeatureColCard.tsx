...
export const FeatureColCard: React.FC<Props> = ({
  ...
  return (
    <div className="flex p-6 h-full flex-col w-full lg:gap-6 gap-4 bg-grey-50 border border-grey-50 hover:bg-white hover:border-secondary-500 rounded-2xl leading-none no-underline transition-colors outline-hidden select-none">
