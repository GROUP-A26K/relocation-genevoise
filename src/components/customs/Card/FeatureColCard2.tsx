...
export const FeatureColCard2: React.FC<Props> = ({
  title,
  description,
  icon: Icon,
  link,
  ...
  return (
    <div className="flex h-full w-full flex-col gap-4 rounded-2xl border border-grey-50 bg-white p-6 leading-none no-underline outline-hidden transition-colors select-none hover:border-secondary-500 lg:gap-6">
