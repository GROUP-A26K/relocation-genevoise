...
export const FeatureColCard2: React.FC<Props> = ({
  ...
  return (
    <div className="flex p-6 h-full flex-col w-full lg:gap-6 gap-4 border border-grey-50 bg-white hover:border-primary-500 rounded-2xl leading-none no-underline transition-colors outline-none select-none">
